...
# Allow `python trading/examples/almgren_chriss_demo.py` as well as
# `python -m trading.examples.almgren_chriss_demo`.
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..')))

from trading.src.models.market_impact import AlmgrenChrissModel
from trading.src.visualization.almgren_chriss_visualizer import AlmgrenChrissVisualizer
